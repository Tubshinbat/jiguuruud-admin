...
const Edit = (props) => {
  ...
  useEffect(() => {
    if (props.banner) {
      if (
        props.banner[cookies.language] &&
        props.banner[cookies.language].name
      ) {
        const { name, details } = props.banner[cookies.language];
        props.banner.name = name;
        props.banner.details = details;
        delete props.banner["eng"];
        delete props.banner["mn"];
      }
