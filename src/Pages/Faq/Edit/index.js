...
const Add = (props) => {
  ...
  useEffect(() => {
    if (props.faq) {
      if (props.faq[cookies.language] && props.faq[cookies.language].answer) {
        const { answer, question } = props.faq[cookies.language];
        props.faq.answer = answer;
        props.faq.question = question;
        delete props.faq["eng"];
        delete props.faq["mn"];
      }
  ...
  return (
    <>
      <div className="content-wrapper">
        <PageTitle name="Түгээмэл асуулт хариулт шинчлэх" />
