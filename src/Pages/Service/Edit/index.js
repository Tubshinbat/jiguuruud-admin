...
const Add = (props) => {
  ...
  useEffect(() => {
    if (props.service) {
      if (
        props.service[cookies.language] &&
        props.service[cookies.language].name
      ) {
        const { name, details } = props.service[cookies.language];
        props.service.name = name;
        props.service.details = details;
        delete props.service["eng"];
        delete props.service["mn"];
      }
