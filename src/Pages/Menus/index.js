...
const SiteMenu = (props) => {
  ...
  useEffect(() => {
    ...
    if (props.category) {
      ...
      if (cat[cookies.language] && cat[cookies.language].name) {
        props.category.name = cat[cookies.language].name;
      } else if (cookies.language === "mn") {
        props.category.name =
          cat["eng"].name + " / Монгол орчуулга оруулаагүй /";
      } else if (cookies.language === "eng") {
        props.category.name = cat["mn"].name + " / Англи орчуулга оруулаагүй /";
      }
